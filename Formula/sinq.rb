class Sinq < Formula
  ...
  url "https://github.com/Veitangie/sinq/archive/refs/tags/v1.0.0-rc.25.tar.gz"
  sha256 "1b634506a93056ffcf5cdd4babae169e82f8f303e212087b5240937bfb838e3c"
  ...
  def install
    system "go", "build", "-trimpath", "-ldflags", "-s -w -X 'main.version=v1.0.0-rc.25'", "-o", bin/"sinq", "./cmd/sinq"
