class Sinq < Formula
  ...
  url "https://github.com/Veitangie/sinq/archive/refs/tags/v1.0.0-rc.27.tar.gz"
  sha256 "d629a3fb4e6bc7e89f921b7de32812ac5b36e6adc1050aa0a0a941802a5cf5e4"
  ...
  def install
    system "go", "build", "-trimpath", "-ldflags", "-s -w -X 'main.version=v1.0.0-rc.27'", "-o", bin/"sinq", "./cmd/sinq"
