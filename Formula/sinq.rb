class Sinq < Formula
  ...
  url "https://github.com/Veitangie/sinq/archive/refs/tags/v1.0.0-rc.28.tar.gz"
  sha256 "31a96e846b832f7f74a932d5a79b966381549d385634bd4042994af8d3df9668"
  ...
  def install
    system "go", "build", "-trimpath", "-ldflags", "-s -w -X 'main.version=v1.0.0-rc.28'", "-o", bin/"sinq", "./cmd/sinq"
