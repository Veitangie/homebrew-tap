class Sinq < Formula
  ...
  url "https://github.com/Veitangie/sinq/archive/refs/tags/v1.0.0-rc.21.tar.gz"
  sha256 "08b42f4b7875045e4598b956697ae5861e03c872e7d66ebcd8dae69e94ad8ac9"
  ...
  def install
    system "go", "build", "-trimpath", "-ldflags", "-s -w -X 'main.versionConstPart=sinq v1.0.0-rc.21 - '", "-o", bin/"sinq", "./cmd/sinq"
